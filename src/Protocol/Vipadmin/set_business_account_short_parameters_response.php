...
/**
 * Protobuf message :
 * EncryptServer.Protocol.Vipadmin.set_business_account_short_parameters_response
 */
class set_business_account_short_parameters_response extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'set_business_account_short_parameters_response',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\set_business_account_short_parameters_response#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\set_business_account_short_parameters_response) {

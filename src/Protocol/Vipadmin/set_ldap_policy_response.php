...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.set_ldap_policy_response
 */
class set_ldap_policy_response extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\set_ldap_policy_response#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\set_ldap_policy_response) {

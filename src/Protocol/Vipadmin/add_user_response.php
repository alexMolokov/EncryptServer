...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.add_user_response
 */
class add_user_response extends \Protobuf\AbstractMessage
{
    ...
    /**
     * registered_login optional string = 6
     *
     * @var string
     */
    protected $registered_login = null;
    ...
    /**
     * Check if 'registered_login' has a value
     *
     * @return bool
     */
    public function hasRegisteredLogin()
    {
        return $this->registered_login !== null;
    }

    /**
     * Get 'registered_login' value
     *
     * @return string
     */
    ...
    /**
     * Set 'registered_login' value
     *
     * @param string $value
     */
    public function setRegisteredLogin($value = null)
    {
        $this->registered_login = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setRegisteredLogin($values['registered_login']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\add_user_response#id" (tag 1) is required but has no value.');
        }
        ...
        if ($this->registered_login !== null) {
            $writer->writeVarint($stream, 50);
            $writer->writeString($stream, $this->registered_login);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 6) {
                ...
                $this->registered_login = $reader->readString($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->registered_login !== null) {
            $size += 1;
            $size += $calculator->computeStringSize($this->registered_login);
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\add_user_response) {
        ...
        $this->registered_login = ($message->registered_login !== null) ? $message->registered_login : $this->registered_login;
    }

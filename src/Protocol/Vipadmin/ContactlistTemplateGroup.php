...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.ContactlistTemplateGroup
 */
class ContactlistTemplateGroup extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ContactlistTemplateGroup#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\ContactlistTemplateGroup) {

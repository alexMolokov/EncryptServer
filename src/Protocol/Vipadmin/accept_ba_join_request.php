...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.accept_ba_join_request
 */
class accept_ba_join_request extends \Protobuf\AbstractMessage
{
    ...
    /**
     * user_pack_id optional string = 5
     *
     * @var string
     */
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\accept_ba_join_request#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\accept_ba_join_request) {

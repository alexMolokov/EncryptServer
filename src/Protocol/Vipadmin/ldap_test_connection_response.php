...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.ldap_test_connection_response
 */
class ldap_test_connection_response extends \Protobuf\AbstractMessage
{
    ...
    /**
     * result optional message = 4
     *
     * @var \EncryptServer\Protocol\Vipadmin\ldap_connection_status
     */
     ...
     * Get 'result' value
     *
     * @return \EncryptServer\Protocol\Vipadmin\ldap_connection_status
     */
     ...
     * Set 'result' value
     *
     * @param \EncryptServer\Protocol\Vipadmin\ldap_connection_status $value
     */
    public function setResult(\EncryptServer\Protocol\Vipadmin\ldap_connection_status $value = null)
    {
        $this->result = $value;
    }
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'ldap_test_connection_response',
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_OPTIONAL(),
                    'type_name' => '.EncryptServer.Protocol.Vipadmin.ldap_connection_status'
                ]),
            ],
        ]);
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ldap_test_connection_response#id" (tag 1) is required but has no value.');
        }
        ...
        if ($this->result !== null) {
            ...
            $writer->writeVarint($stream, $this->result->serializedSize($sizeContext));
            $this->result->writeTo($context);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 4) {
                ...
                $innerMessage = new \EncryptServer\Protocol\Vipadmin\ldap_connection_status();

                $this->result = $innerMessage;
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->result !== null) {
            $innerSize = $this->result->serializedSize($context);
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\ldap_test_connection_response) {

...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.ExportAccountAutoconfKey
 */
class ExportAccountAutoconfKey extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ExportAccountAutoconfKey#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\ExportAccountAutoconfKey) {

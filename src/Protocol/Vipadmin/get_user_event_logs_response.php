...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.get_user_event_logs_response
 */
class get_user_event_logs_response extends \Protobuf\AbstractMessage
{
    ...
    /**
     * log_items repeated message = 5
     *
     * @var \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\UserLogItem>
     */
    protected $log_items = null;
    ...
    /**
     * Check if 'log_items' has a value
     *
     * @return bool
     */
    public function hasLogItemsList()
    {
        return $this->log_items !== null;
    }

    /**
     * Get 'log_items' value
     *
     * @return \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\UserLogItem>
     */
    public function getLogItemsList()
    {
     ...
     * Set 'log_items' value
     *
     * @param \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\UserLogItem> $value
     */
    public function setLogItemsList(\Protobuf\Collection $value = null)
    {
        $this->log_items = $value;
    }

    /**
     * Add a new element to 'log_items'
     *
     * @param \EncryptServer\Protocol\Vipadmin\UserLogItem $value
     */
    public function addLogItems(\EncryptServer\Protocol\Vipadmin\UserLogItem $value)
    {
        if ($this->log_items === null) {
            $this->log_items = new \Protobuf\MessageCollection();
        }

        $this->log_items->add($value);
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        foreach ($values['log_items'] as $item) {
            $message->addLogItems($item);
        }
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'get_user_event_logs_response',
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.EncryptServer.Protocol.Vipadmin.UserLogItem'
                ]),
            ],
        ]);
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\get_user_event_logs_response#id" (tag 1) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 5) {
                ...
                $innerMessage = new \EncryptServer\Protocol\Vipadmin\UserLogItem();

                if ($this->log_items === null) {
                    $this->log_items = new \Protobuf\MessageCollection();
                }

                $this->log_items->add($innerMessage);
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\get_user_event_logs_response) {
        ...
        $this->log_items = ($message->log_items !== null) ? $message->log_items : $this->log_items;
    }

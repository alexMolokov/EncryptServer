...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.ba_shared_contactlist
 */
class ba_shared_contactlist extends \Protobuf\AbstractMessage
{
    ...
    /**
     * Check if 'parameter2' has a value
     *
     * @return bool
     */
    public function hasParameter2()
    {
        return $this->parameter2 !== null;
    }

    /**
     * Get 'parameter2' value
     *
     * @return string
     */
     ...
     * @param string $value
     */
    public function setParameter2($value = null)
    {
        $this->parameter2 = $value;
    }

    /**
     * Check if 'parameter3' has a value
     *
     * @return bool
     */
    public function hasParameter3()
    {
        return $this->parameter3 !== null;
    }

    /**
     * Get 'parameter3' value
     *
     * @return string
     */
     ...
     * @param string $value
     */
    public function setParameter3($value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setParameter2($values['parameter2']);
        $message->setParameter3($values['parameter3']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ba_shared_contactlist#id" (tag 1) is required but has no value.');
        }
        ...
        if ($this->parameter1 !== null) {
            ...
            $writer->writeString($stream, $this->parameter1);
        }

        if ($this->parameter2 !== null) {
            $writer->writeVarint($stream, 58);
            $writer->writeString($stream, $this->parameter2);
        }

        if ($this->parameter3 !== null) {
            $writer->writeVarint($stream, 66);
            $writer->writeString($stream, $this->parameter3);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 6) {
                ...
                $this->parameter1 = $reader->readString($stream);
            ...
            if ($tag === 7) {
                ...
                $this->parameter2 = $reader->readString($stream);
            ...
            if ($tag === 8) {
                ...
                $this->parameter3 = $reader->readString($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->parameter1 !== null) {
            $size += 1;
            $size += $calculator->computeStringSize($this->parameter1);
        }

        if ($this->parameter2 !== null) {
            $size += 1;
            $size += $calculator->computeStringSize($this->parameter2);
        }

        if ($this->parameter3 !== null) {
            $size += 1;
            $size += $calculator->computeStringSize($this->parameter3);
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\ba_shared_contactlist) {
        ...
        $this->parameter2 = ($message->parameter2 !== null) ? $message->parameter2 : $this->parameter2;
        $this->parameter3 = ($message->parameter3 !== null) ? $message->parameter3 : $this->parameter3;
    }

...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.get_user_logs
 */
class get_user_logs extends \Protobuf\AbstractMessage
{
    ...
    {
        $this->sort_desc = true;
        $this->sort_field = \EncryptServer\Protocol\Vipadmin\get_user_logs\Field::FIELD_TIME();
        $this->offset = '0';
     ...
     *
     * @param \EncryptServer\Protocol\Vipadmin\get_user_logs\Field $value
     */
    public function setSortField(\EncryptServer\Protocol\Vipadmin\get_user_logs\Field $value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $values  = array_merge([
            ...
            'sort_desc' => true,
            'sort_field' => \EncryptServer\Protocol\Vipadmin\get_user_logs\Field::FIELD_TIME(),
            'offset' => '0',
            'filter' => [],
            'login' => null
        ], $values);
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_OPTIONAL(),
                    'type_name' => '.EncryptServer.Protocol.Vipadmin.get_user_logs.Field',
                    'default_value' => \EncryptServer\Protocol\Vipadmin\get_user_logs\Field::FIELD_TIME()
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 6,
                    'name' => 'offset',
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\get_user_logs#id" (tag 1) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 5) {
                ...
                $this->sort_field = \EncryptServer\Protocol\Vipadmin\get_user_logs\Field::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\get_user_logs) {

...
/**
 * Protobuf message :
 * EncryptServer.Protocol.Vipadmin.move_user_to_business_account_response
 */
class move_user_to_business_account_response extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'move_user_to_business_account_response',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\move_user_to_business_account_response#id" (tag 1) is required but has no value.');
        }

        if ($this->domain_id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\move_user_to_business_account_response#domain_id" (tag 2) is required but has no value.');
        }

        if ($this->status === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\move_user_to_business_account_response#status" (tag 3) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\move_user_to_business_account_response) {

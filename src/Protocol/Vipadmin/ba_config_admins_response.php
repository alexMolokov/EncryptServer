...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.ba_config_admins_response
 */
class ba_config_admins_response extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'ba_config_admins_response',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ba_config_admins_response#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\ba_config_admins_response) {

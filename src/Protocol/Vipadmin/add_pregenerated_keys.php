...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.add_pregenerated_keys
 */
class add_pregenerated_keys extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\add_pregenerated_keys#id" (tag 1) is required but has no value.');
        }

        if ($this->business_account_id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\add_pregenerated_keys#business_account_id" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\add_pregenerated_keys) {

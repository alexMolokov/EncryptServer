...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.ba_config_admins
 */
class ba_config_admins extends \Protobuf\AbstractMessage
{
    ...
    /**
     * admins repeated message = 4
     *
     * @var \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\BaAdministratorConfig>
     */
     ...
     * Get 'admins' value
     *
     * @return \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\BaAdministratorConfig>
     */
     ...
     * Set 'admins' value
     *
     * @param \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\BaAdministratorConfig> $value
     */
    public function setAdminsList(\Protobuf\Collection $value = null)
    {
        $this->admins = $value;
    }
     ...
     *
     * @param \EncryptServer\Protocol\Vipadmin\BaAdministratorConfig $value
     */
    public function addAdmins(\EncryptServer\Protocol\Vipadmin\BaAdministratorConfig $value)
    {
        if ($this->admins === null) {
            $this->admins = new \Protobuf\MessageCollection();
        }
    ...
    public static function fromArray(array $values)
    {
        ...
        foreach ($values['admins'] as $item) {
            $message->addAdmins($item);
        }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.EncryptServer.Protocol.Vipadmin.BaAdministratorConfig'
                ]),
            ],
        ]);
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ba_config_admins#id" (tag 1) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 4) {
                ...
                $innerMessage = new \EncryptServer\Protocol\Vipadmin\BaAdministratorConfig();

                if ($this->admins === null) {
                    $this->admins = new \Protobuf\MessageCollection();
                }

                $this->admins->add($innerMessage);
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\ba_config_admins) {
        ...
        $this->admins = ($message->admins !== null) ? $message->admins : $this->admins;
    }

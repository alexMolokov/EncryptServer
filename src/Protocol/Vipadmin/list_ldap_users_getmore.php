...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.list_ldap_users_getmore
 */
class list_ldap_users_getmore extends \Protobuf\AbstractMessage
{
     ...
     * @param bool $value
     */
    public function setStop($value = null)
    {
        $this->stop = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\list_ldap_users_getmore#id" (tag 1) is required but has no value.');
        }
        ...
        if ($this->stop !== null) {
            ...
            $writer->writeBool($stream, $this->stop);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 5) {
                ...
                $this->stop = $reader->readBool($stream);
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\list_ldap_users_getmore) {
        ...
        $this->stop = ($message->stop !== null) ? $message->stop : $this->stop;
    }

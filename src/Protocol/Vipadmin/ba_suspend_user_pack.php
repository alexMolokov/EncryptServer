...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.ba_suspend_user_pack
 */
class ba_suspend_user_pack extends \Protobuf\AbstractMessage
{
    ...
    /**
     * user_pack_id optional string = 3
     *
     * @var string
     */
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ba_suspend_user_pack#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\ba_suspend_user_pack) {

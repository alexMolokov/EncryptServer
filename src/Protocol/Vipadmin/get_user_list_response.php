...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.get_user_list_response
 */
class get_user_list_response extends \Protobuf\AbstractMessage
{
    ...
    /**
     * users repeated message = 8
     *
     * @var \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\User>
     */
    protected $users = null;

    /**
     * extra_code optional int32 = 9
     *
     * @var int
     */
     ...
     * Get 'users' value
     *
     * @return \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\User>
     */
     ...
     * Set 'users' value
     *
     * @param \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\User> $value
     */
     ...
     *
     * @param \EncryptServer\Protocol\Vipadmin\User $value
     */
    public function addUsers(\EncryptServer\Protocol\Vipadmin\User $value)
    {
        if ($this->users === null) {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.EncryptServer.Protocol.Vipadmin.User'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 9,
                    'name' => 'extra_code',
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\get_user_list_response#id" (tag 1) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 8) {
                ...
                $innerMessage = new \EncryptServer\Protocol\Vipadmin\User();
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\get_user_list_response) {

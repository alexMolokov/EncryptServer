...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.ba_delete_admin
 */
class ba_delete_admin extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ba_delete_admin#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\ba_delete_admin) {

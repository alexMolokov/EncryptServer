...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.delete_users_response
 */
class delete_users_response extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\delete_users_response#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\delete_users_response) {

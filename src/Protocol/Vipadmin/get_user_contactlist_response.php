...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.get_user_contactlist_response
 */
class get_user_contactlist_response extends \Protobuf\AbstractMessage
{
    ...
    /**
     * groups repeated message = 6
     *
     * @var \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\ContactListGroup>
     */
    protected $groups = null;

    /**
     * ungroupped_users repeated message = 7
     *
     * @var \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\ContactListUser>
     */
    protected $ungroupped_users = null;
     ...
     * Get 'groups' value
     *
     * @return \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\ContactListGroup>
     */
     ...
     * Set 'groups' value
     *
     * @param \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\ContactListGroup> $value
     */
    public function setGroupsList(\Protobuf\Collection $value = null)
    {
        $this->groups = $value;
    }
     ...
     *
     * @param \EncryptServer\Protocol\Vipadmin\ContactListGroup $value
     */
    public function addGroups(\EncryptServer\Protocol\Vipadmin\ContactListGroup $value)
    {
        if ($this->groups === null) {
            $this->groups = new \Protobuf\MessageCollection();
        }
    ...
    /**
     * Check if 'ungroupped_users' has a value
     *
     * @return bool
     */
    public function hasUngrouppedUsersList()
    {
        return $this->ungroupped_users !== null;
    }

    /**
     * Get 'ungroupped_users' value
     *
     * @return \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\ContactListUser>
     */
    public function getUngrouppedUsersList()
    {
        return $this->ungroupped_users;
    }

    /**
     * Set 'ungroupped_users' value
     *
     * @param \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\ContactListUser> $value
     */
    public function setUngrouppedUsersList(\Protobuf\Collection $value = null)
    {
        $this->ungroupped_users = $value;
    }

    /**
     * Add a new element to 'ungroupped_users'
     *
     * @param \EncryptServer\Protocol\Vipadmin\ContactListUser $value
     */
    public function addUngrouppedUsers(\EncryptServer\Protocol\Vipadmin\ContactListUser $value)
    {
        if ($this->ungroupped_users === null) {
            $this->ungroupped_users = new \Protobuf\MessageCollection();
        }

        $this->ungroupped_users->add($value);
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        foreach ($values['groups'] as $item) {
            $message->addGroups($item);
        }

        foreach ($values['ungroupped_users'] as $item) {
            $message->addUngrouppedUsers($item);
        }
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'get_user_contactlist_response',
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.EncryptServer.Protocol.Vipadmin.ContactListGroup'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 7,
                    'name' => 'ungroupped_users',
                    'type' => \google\protobuf\FieldDescriptorProto\Type::TYPE_MESSAGE(),
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_REPEATED(),
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\get_user_contactlist_response#id" (tag 1) is required but has no value.');
        }
        ...
        if ($this->ungroupped_users !== null) {
            foreach ($this->ungroupped_users as $val) {
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 6) {
                ...
                $innerMessage = new \EncryptServer\Protocol\Vipadmin\ContactListGroup();

                if ($this->groups === null) {
                    $this->groups = new \Protobuf\MessageCollection();
                }

                $this->groups->add($innerMessage);
            ...
            if ($tag === 7) {
                ...
                $this->ungroupped_users->add($innerMessage);
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\get_user_contactlist_response) {
        ...
        $this->groups = ($message->groups !== null) ? $message->groups : $this->groups;
        $this->ungroupped_users = ($message->ungroupped_users !== null) ? $message->ungroupped_users : $this->ungroupped_users;
    }

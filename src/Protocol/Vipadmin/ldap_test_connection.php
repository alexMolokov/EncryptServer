...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.ldap_test_connection
 */
class ldap_test_connection extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setParameters(\EncryptServer\Protocol\Vipadmin\server_parameters_ldap $value)
    {
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ldap_test_connection#id" (tag 1) is required but has no value.');
        }

        if ($this->parameters === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\ldap_test_connection#parameters" (tag 3) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\ldap_test_connection) {

...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.update_profile_from_ldap
 */
class update_profile_from_ldap extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\update_profile_from_ldap#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\update_profile_from_ldap) {

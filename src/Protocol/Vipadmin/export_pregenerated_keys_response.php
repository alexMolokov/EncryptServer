...
/**
 * Protobuf message :
 * EncryptServer.Protocol.Vipadmin.export_pregenerated_keys_response
 */
class export_pregenerated_keys_response extends \Protobuf\AbstractMessage
{
    ...
    /**
     * keys repeated message = 4
     *
     * @var \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\pregenerated_key>
     */
    protected $keys = null;
     ...
     * Get 'keys' value
     *
     * @return \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\pregenerated_key>
     */
     ...
     * Set 'keys' value
     *
     * @param \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\pregenerated_key> $value
     */
     ...
     *
     * @param \EncryptServer\Protocol\Vipadmin\pregenerated_key $value
     */
    public function addKeys(\EncryptServer\Protocol\Vipadmin\pregenerated_key $value)
    {
        if ($this->keys === null) {
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'export_pregenerated_keys_response',
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.EncryptServer.Protocol.Vipadmin.pregenerated_key'
                ]),
            ],
        ]);
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\export_pregenerated_keys_response#id" (tag 1) is required but has no value.');
        }

        if ($this->business_account_id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\export_pregenerated_keys_response#business_account_id" (tag 2) is required but has no value.');
        }

        if ($this->status === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\export_pregenerated_keys_response#status" (tag 3) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 4) {
                ...
                $innerMessage = new \EncryptServer\Protocol\Vipadmin\pregenerated_key();
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\export_pregenerated_keys_response) {

...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.get_ba_admins_response
 */
class get_ba_admins_response extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\BaAdministrator>
     */
     ...
     * Get 'admins' value
     *
     * @return \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\BaAdministrator>
     */
     ...
     * Set 'admins' value
     *
     * @param \Protobuf\Collection<\EncryptServer\Protocol\Vipadmin\BaAdministrator> $value
     */
     ...
     *
     * @param \EncryptServer\Protocol\Vipadmin\BaAdministrator $value
     */
    public function addAdmins(\EncryptServer\Protocol\Vipadmin\BaAdministrator $value)
    {
        if ($this->admins === null) {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.EncryptServer.Protocol.Vipadmin.BaAdministrator'
                ]),
            ],
        ]);
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\get_ba_admins_response#id" (tag 1) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 4) {
                ...
                $innerMessage = new \EncryptServer\Protocol\Vipadmin\BaAdministrator();
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\get_ba_admins_response) {

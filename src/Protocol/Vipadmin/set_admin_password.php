...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.set_admin_password
 */
class set_admin_password extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\set_admin_password) {

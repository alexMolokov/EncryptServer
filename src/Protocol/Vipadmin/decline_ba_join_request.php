...
/**
 * Protobuf message : EncryptServer.Protocol.Vipadmin.decline_ba_join_request
 */
class decline_ba_join_request extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\decline_ba_join_request#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\decline_ba_join_request) {

...
/**
 * Protobuf message :
 * EncryptServer.Protocol.Vipadmin.user_contactlist_operation_response
 */
class user_contactlist_operation_response extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'user_contactlist_operation_response',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->id === null) {
            throw new \UnexpectedValueException('Field "\\EncryptServer\\Protocol\\Vipadmin\\user_contactlist_operation_response#id" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \EncryptServer\Protocol\Vipadmin\user_contactlist_operation_response) {
